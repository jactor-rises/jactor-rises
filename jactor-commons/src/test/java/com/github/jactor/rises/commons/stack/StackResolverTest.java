...
class StackResolverTest {
    ...
    @Test void shouldProduceStackFrames() {
        ...
        assertAll(
                ...
                () -> assertThat(stack.get(0).asString()).as("first frame").contains("com.github.jactor.rises.commons.stack.StackResolverTest$Service.simulateMethodCall(StackResolverTest.java:"),
                () -> assertThat(stack.get(1).asString()).as("second frame").contains("com.github.jactor.rises.commons.stack.StackResolverTest.shouldProduceStackFrames(StackResolverTest.java:")
        );
    }
    ...
    @Test void shouldLogStack() {
        ...
        assertAll(
                ...
                () -> verify(msgLogMock).log(contains("    com.github.jactor.rises.commons.stack.StackResolverTest$Service.simulateExceptionInMethod(StackResolverTest.java:")),
                () -> verify(msgLogMock).log(contains("    com.github.jactor.rises.commons.stack.StackResolverTest.shouldLogStack(StackResolverTest.java:")),
